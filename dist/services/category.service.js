...
var CategoryService = /** @class */ (function () {
    ...
    CategoryService.prototype.findById = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Category_1.default.findById(id).populate("products")];
                    case 1:
                        category = _a.sent();
    ...
    CategoryService.prototype.addProduct = function (categoryId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            var category;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Category_1.default.findByIdAndUpdate(categoryId, {
                            $push: { products: { $each: [productId], $position: 0 } },
                        }, { new: true })];
                    case 1:
                        category = _a.sent();
                        if (!category) {
                            throw (0, errors_1.createError)(404, "Category not found.");
                        }
    ...
    CategoryService.prototype.deleteProduct = function (categoryId, productId) {
        return __awaiter(this, void 0, void 0, function () {
            var category;
            return __generator(this, function (_a) {
                switch (_a.label) {
