...
var ProductsService = /** @class */ (function () {
    ...
    ProductsService.prototype.findAll = function (search, filter, skip, limit) {
        return __awaiter(this, void 0, void 0, function () {
            var products, total;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Product_1.default.find().skip(skip).limit(limit)];
                    case 1:
                        products = _a.sent();
    ...
    ProductsService.prototype.findById = function (_id) {
        return __awaiter(this, void 0, void 0, function () {
            var product;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, Product_1.default.findOne({ _id: _id })];
                    case 1:
                        product = _a.sent();
